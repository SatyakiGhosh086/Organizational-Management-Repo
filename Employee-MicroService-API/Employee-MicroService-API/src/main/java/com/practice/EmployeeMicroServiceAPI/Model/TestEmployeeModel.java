package com.practice.EmployeeMicroServiceAPI.Model;
...
public class TestEmployeeModel 
{
	...
	public TestEmployeeModel(int employeeId, String firstName, String lastName, String dateOfJoining, int departmentId) {
		super();
		this.employeeId = employeeId;
		this.firstName = firstName;
		this.lastName = lastName;
